...
static void tst(int argc, char **argv)
{
    ...
    yaz_snprintf(path, sizeof(path), "%s/m1.xml", tl_get_srcdir());
    zebra_repository_update(zh, path);
    yaz_snprintf(path, sizeof(path), "%s/m2.xml", tl_get_srcdir());
    zebra_repository_update(zh, path);
    yaz_snprintf(path, sizeof(path), "%s/m3.xml", tl_get_srcdir());
    zebra_repository_update(zh, path);
